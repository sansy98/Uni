...
for i=1:n-1
 for j=i+1:n
L(j,i)=c(j,i)/c(i,i); // Cálculo de los coeficientes de la matriz L, multiplicadores.
c(j,:)=c(j,:)-L(j,i)*c(i,:); // Proceso de eliminación y cálculo de los coeficientes de la matriz U Y actualización de b
 end
end
//FASE SOLUCIÓN
